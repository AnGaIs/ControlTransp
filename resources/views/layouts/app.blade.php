...
<body class="skin-blue">  
    <header class="header">
        <a href="{{ URL('/') }}" class="logo bgpersonalizado" style="text-transform: uppercase">{{ config('app.name', 'Rizer') }}</a>
                        ...
                        <ul class="dropdown-menu">
                            <li class="user-footer">
                                <div class="pull-right">
                                    <a href="{{ URL('/') }}/perfil" class="btn btn-default btn-sm">Editar Perfil</a>&emsp;&nbsp;
                                    <a href="{{ route('logout') }}" class="btn btn-default btn-sm" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Sair</a>
                                </div>
                            </li>
                        </ul>
                    </li>
        ...
        <aside class="left-side sidebar-offcanvas">
            <section class="sidebar">
                <ul id="menu" class="sidebar-menu">
                    ...
                    <li id="principal">
                        <a href="{{ URL('/') }}">
                            <i class="fa fa-windows" style="color: gray;"></i>
                            <span>Principal</span>
                        </a>
                    </li>
                    ...
                    <li id='skus'>
                        <a href="{{ URL('/') }}/ocs">
                            ...
                            <span>Importação de Ocs</span>
                        </a>
                    </li>

                    <li id='skus'>
                        <a href="{{ URL('/') }}/paletizador">
                            <i class="fa fa-stack-overflow " style="color: gray;"></i>
                            <span>Paletização</span>
                        </a>
                    </li>
                    ...
                    <li id='indicators'>
                        <a href="{{ URL('/') }}/indicators">
                            <i class="fa fa-bar-chart" style="color: gray;"></i>
                    ...
                    <li id='reports'>
                        <a href="{{ URL('/') }}/reports">
                            <i class="fa fa-wpforms" style="color: gray;"></i>
